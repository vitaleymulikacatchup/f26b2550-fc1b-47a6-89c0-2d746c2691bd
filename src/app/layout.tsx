...
export const metadata: Metadata = {
  title: "TechFlow - Leading IT Solutions & Digital Transformation",
  description: "Transform your business with TechFlow's cutting-edge IT solutions. Cloud infrastructure, cybersecurity, mobile development, and AI solutions.",
  keywords: ["IT solutions", "cloud infrastructure", "cybersecurity", "mobile development", "AI solutions", "digital transformation"],
